...
export default async function ServiceDetailPage({
  ...
  const deliveryModeIcon: IconName =
    service.defaultMode === "hybrid"
      ? "hybrid"
      : service.defaultMode === "on-site"
        ? "onsite"
        : "remote";
      ...
      <section className="mx-auto w-full max-w-5xl px-6 pb-16 pt-12">
        <MotionIn className="space-y-8">
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-3 rounded-2xl border border-line/80 bg-soft p-4 text-xs uppercase tracking-[0.2em] text-slate md:grid-cols-3">
              <div className="flex flex-col gap-2">
                ...
                <span className="inline-flex items-center gap-2 text-ash">
                  <IconStatic name="duration" size={16} className="text-slate" />
            ...
            <div className="rounded-2xl border border-line/80 bg-soft p-4">
              <h2 className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-slate">
                <IconStatic name="process" size={16} className="text-slate" />
                What happens next
              </h2>
        ...
        <div className="mt-12 space-y-10">
          <MotionIn className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-line/80 bg-soft p-6">
              <h2 className="flex items-center gap-2 text-sm uppercase tracking-[0.2em] text-slate">
                <IconStatic name="fit" size={18} className="text-slate" />
                Best for
              </h2>
          ...
          <MotionIn className="space-y-4">
            <h2 className="flex items-center gap-2 text-xl font-semibold text-ash">
              <IconStatic name="outcomes" size={18} className="text-slate" />
              Expected outcomes
            </h2>
          ...
          <MotionIn className="space-y-4">
            <h2 className="flex items-center gap-2 text-xl font-semibold text-ash">
              <IconStatic name="deliverables" size={18} className="text-slate" />
            ...
            <div className="rounded-2xl border border-line/80 bg-soft p-4">
              <h3 className="flex items-center gap-2 text-sm uppercase tracking-[0.2em] text-slate">
                <IconStatic
                  name="definitionDone"
                  size={16}
                  className="text-slate"
          ...
          <MotionIn className="space-y-4">
            <h2 className="flex items-center gap-2 text-xl font-semibold text-ash">
              <IconStatic name="process" size={18} className="text-slate" />
              Process
            </h2>
          ...
          <MotionIn className="space-y-4">
            <h2 className="flex items-center gap-2 text-xl font-semibold text-ash">
              <IconStatic name="inputs" size={18} className="text-slate" />
          ...
          <MotionIn className="space-y-6 rounded-2xl border border-line/80 bg-soft p-6">
            <div className="space-y-2">
              <h2 className="flex items-center gap-2 text-xl font-semibold text-ash">
                <IconStatic name="pricing" size={18} className="text-slate" />
                Pricing & duration
              </h2>
          ...
          <MotionIn className="space-y-4 rounded-2xl border border-line/80 bg-soft p-6">
            <h2 className="flex items-center gap-2 text-lg font-semibold text-ash">
              <IconStatic name="security" size={18} className="text-slate" />
          ...
          <MotionIn className="space-y-4 rounded-2xl border border-line/80 bg-soft p-6">
            <h2 className="flex items-center gap-2 text-lg font-semibold text-ash">
              <IconStatic name="faq" size={18} className="text-slate" />
              FAQ
            </h2>
